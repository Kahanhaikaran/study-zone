...
const BreadcrumbServicesDetails = () => {
  return (
    <>
            ...
            <div className="page-heading">
                <ul className="breadcrumb-items">
                    <li><Link href="/">Home</Link></li>
                        <li><Link href="/services-grid">Services</Link></li>
                        <li className="style-2"> Service Details</li>
                </ul>
                <div className="breadcrumb-content">
                    <h1>Advance UX/UI Design Using Figma</h1>
                    <div className="courses-breadcrumb-items">
                        <div className="client-image-items">
                            <img src="/assets/img/services/client-3.png" alt="img" />
...
export default BreadcrumbServicesDetails;
