                ...
                <div className="row g-4">
                    <div className="col-xl-3 col-lg-4">
                        <div className="courses-main-sidebar-area sticky-style">
                            ...
                            <Link href="/services" className="theme-btn"><i className="far fa-times-circle"></i> Clear All Filters</Link>
                        </div>
                    </div>
                        ...
                        <div className="coureses-notices-wrapper">
                            <div className="courses-showing">
                                <div className="icon-items">
                                    <Link href="/services-grid"><i className="fas fa-th"></i></Link>
                                    <Link href="/services-list"><i className="fas fa-bars"></i></Link>
                                </div>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="courses-list-items">
                                    <div className="thumb">
                                        <img src="/assets/img/services/list/01.jpg" alt="img" />
                                ...
                                <div className="courses-list-items">
                                    <div className="thumb">
                                        <img src="/assets/img/services/list/02.jpg" alt="img" />
                                ...
                                <div className="courses-list-items">
                                    <div className="thumb">
                                        <img src="/assets/img/services/list/03.jpg" alt="img" />
                                    ...
                                    <div className="content">
                                        ...
                                        <ul className="post-cat">
                                            <li>
                                                <Link href="/services">Programming</Link>
                                            </li>
                                            <li>
                                                <i className="fas fa-star"></i>
                                                <i className="fas fa-star"></i>
                                ...
                                <div className="courses-list-items">
                                    <div className="thumb">
                                        <img src="/assets/img/services/list/04.jpg" alt="img" />
                                ...
                                <div className="courses-list-items">
                                    <div className="thumb">
                                        <img src="/assets/img/services/list/05.jpg" alt="img" />
                                    ...
                                    <div className="content">
                                        ...
                                        <ul className="post-cat">
                                            <li>
                                                <Link href="/services">Tech & AI</Link>
                                            </li>
                                            <li>
                                                <i className="fas fa-star"></i>
                                                <i className="fas fa-star"></i>
                                ...
                                <div className="courses-list-items">
                                    <div className="thumb">
                                        <img src="/assets/img/services/list/06.jpg" alt="img" />
                                    ...
                                    <div className="content">
                                        ...
                                        <ul className="post-cat">
                                            <li>
                                                <Link href="/services">Leadership</Link>
                                            </li>
                                            <li>
                                                <i className="fas fa-star"></i>
                                                <i className="fas fa-star"></i>
...
export default ServicesListArea;
